  ...
  return (
    <section className="pt-32 pb-12 px-6">
      <div className="container mx-auto max-w-5xl">
        ...
        >
          We transform ideas into impactful
                      
           software that <span className="inline-flex items-center justify-center w-10 h-10 md:w-14 md:h-14 rounded-full text-[rgba(192,12,12,0.22)] bg-[rgba(10,10,10,0.14673913043478262)]">
              <Handshake className="w-5 h-5 md:w-7 md:h-7 text-[rgba(255,117,38,1)]" />
            </span> breaks the mold.
        </motion.h1>
        ...
        >
          We build open source and custom software for businesses.
        </motion.p>
