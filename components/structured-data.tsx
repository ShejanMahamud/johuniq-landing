export default function StructuredData() {
  ...
  const organizationSchema = {
    ...
    logo: "https://johuniq.tech/logo.png",
    image: "https://johuniq.tech/og-image.png",
  ...
  const websiteSchema = {
    ...
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate: "https://johuniq.tech/search?q={search_term_string}",
      },
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Home",
        item: "https://johuniq.tech",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Services",
        item: "https://johuniq.tech/#services",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "Portfolio",
        item: "https://johuniq.tech/#portfolio",
      },
      {
        "@type": "ListItem",
        position: 4,
        name: "Pricing",
        item: "https://johuniq.tech/#pricing",
      },
    ],
  }
